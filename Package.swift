...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/proximiio/proximiio-map-ios-binary/releases/download/6.0.0-beta.5/ProximiioMapBinary.xcframework.zip",
            checksum: "bb353fff887afbaf064a9a2b52a6ecdfca2282a71a37e3f6bfe2e36691d90d91"
        ),
        // ── the source shim ──────────────────────────────────────────────
