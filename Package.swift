...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/proximiio/proximiio-map-ios-binary/releases/download/6.0.0-beta.6/ProximiioMapBinary.xcframework.zip",
            checksum: "4b1a6a61491b67c47cf14952b5f6bcd6d9bb9405fbb03c1fe325fb77f9ade277"
        ),
        // ── the source shim ──────────────────────────────────────────────
