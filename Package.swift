...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/proximiio/proximiio-map-ios-binary/releases/download/6.0.0-beta.16/ProximiioMapBinary.xcframework.zip",
            checksum: "e86774b95e5211254e1d3b089dc3276bc4182412224a20e2f41f36ae8fda5b8d"
        ),
        // ── the source shim ──────────────────────────────────────────────
